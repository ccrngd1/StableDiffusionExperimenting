...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        example = {}
        #print(f'_getitem_ info: self.instance_images_path { self.instance_images_path} with self.num_instance_images {self.num_instance_images}')
...
def main(args):
    ...
    print(f'mixed_precision set as {args.mixed_precision}') 
    ...
    if args.concepts_list is None:
        ...
        print('pulled concepts_list from args')
    else:
        with open(args.concepts_list, "r") as f:
            args.concepts_list = json.load(f)
            print('loaded concepts_list from file')

    if args.with_prior_preservation:
        pipeline = None
        #print(f'checking concepts_list {args.concepts_list}')
        for concept in args.concepts_list:
            #print(f'checking concept {concept}')
            #print(f'checking concept["class_data_dir"] {concept["class_data_dir"]}')
            class_images_dir = Path(concept["class_data_dir"])
            class_images_dir.mkdir(parents=True, exist_ok=True)
            cur_class_images = len(list(class_images_dir.iterdir()))
            #print('checking class_data_dir')
